...
export function SidebarDemo({ children }) {
  ...
  return (
    (<div
      className={cn(
        "rounded-md flex flex-col md:flex-row w-full max-w-full bg-gray-100 dark:bg-neutral-800 flex-1 mx-auto border border-neutral-200 dark:border-neutral-700 overflow-hidden",
