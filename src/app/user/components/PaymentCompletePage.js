...
export default function CompletePage() {
  ...
  return (
    <div id="payment-status" className="text-center">
      ...
      <h2 id="status-text" className="text-lg font-bold mt-2">
        {STATUS_CONTENT_MAP[status].text}
      </h2>
      {intentId && (
        <div id="details-table" className="mt-4">
      ...
      {/* {intentId && (
        ...
        >
          View details
          <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="inline-block ml-2">
            <path d="M14.6443 6.14433C15.1489 6.64442 15.1489 7.54417 14.6443 8.04427L9.6443 13.0443C9.45349 13.2341 9.12761 13.2341 8.93681 13.0443C8.74601 12.8545 8.74601 12.5287 8.93681 12.3389L13.5077 7.75H0.5C0.223858 7.75 0 7.52614 0 7.25C0 6.97386 0.223858 6.75 0.5 6.75H13.5077L8.93681 2.16109C8.74601 1.9713 8.74601 1.64549 8.93681 1.45569C9.12761 1.26589 9.45349 1.26589 9.6443 1.45569L14.6443 6.14433Z" fill="currentColor" />
          </svg>
        </a>
      )} */}
    </div>
